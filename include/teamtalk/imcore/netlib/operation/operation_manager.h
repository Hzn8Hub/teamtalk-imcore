...
class OperationManager {
 ...
 public:
  ...
  IMCoreErrorCode startOperation(Operation* pOperation, int32_t delay);
  IMCoreErrorCode startOperationWithLambda(std::function<void()> operationRun, int32_t delay, std::string oper_name);
